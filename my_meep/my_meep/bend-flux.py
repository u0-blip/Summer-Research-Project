...
Simulation.run(until_after_sources=mp.stop_when_fields_decayed(50,mp.Ez,pt,1e-3))

plt.figure()
Simulation.plot2D()

# for normalization run, save flux fields data for reflection plane
straight_refl_data = Simulation.get_flux_data(refl)
...
Simulation.load_minus_flux_data(refl,straight_refl_data)
